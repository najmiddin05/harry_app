...
void main() {
  group("chapters map test", () {
    test("chapters map data one test", () async {
      ...
      final chapterMapData = ChaptersMap.fromJson(getChapter);
      debugPrint(chapterMapData.data.list.first.id);
      expect(chapterMapData, const TypeMatcher<ChaptersMap>());
    });

    test("chapters map data all test", () async {
      final response = await Network.methodGet(
        api: Api.apiBook,
      );
      // debugPrint(response);
...
// void main() {
//   group("chapters map test", () {
//     test("chapters map data test", () async {
//       final response = await Network.methodGet(api: Api.apiBook);
//       final json = jsonDecode(response!) as Map<String, dynamic>;
//       final data = json["data"] as Map<String, dynamic>;
//       final chapterMapData = ChaptersMap.fromJson(data);
//       debugPrint(chapterMapData.chaptersData.list.first.type);
//       expect(chapterMapData, TypeMatcher<ChaptersMap>());
//     });
//   });
// }
